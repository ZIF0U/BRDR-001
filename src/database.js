...
class Database {
  ...
  init() {
    this.db.serialize(() => {
      ...
      this.db.run(`INSERT OR IGNORE INTO users (username, password) VALUES ('admin', 'admin')`)
      this.db.run(`INSERT OR IGNORE INTO users (username, password) VALUES ('user', 'password')`)
    })
  }
